...
func (in *ApplicationSource) DeepCopyInto(out *ApplicationSource) {
	*out = *in
	...
	if in.TargetTracking != nil {
		...
		*out = new(ApplicationSourceTargetTracking)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationSourceTargetTracking) DeepCopyInto(out *ApplicationSourceTargetTracking) {
	*out = *in
	if in.AllowTags != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationSourceTargetTracking.
func (in *ApplicationSourceTargetTracking) DeepCopy() *ApplicationSourceTargetTracking {
	if in == nil {
		return nil
	}
	out := new(ApplicationSourceTargetTracking)
